...
public class MailUtil {
	  public static void sendEmail( AccountUser user) throws MessagingException{
	        ...
	        // 设置邮件的内容体
	        message.setContent("亲爱的"+user.getName()+",您在银行账户系统中的密码是"+user.getPassword(), "text/html;charset=UTF-8");
	        // 发送邮件
