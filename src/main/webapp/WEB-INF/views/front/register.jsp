	...
	<div class="sixteen columns " >
		...
		<div id="contact-form">
			<form method="post" action="${pageContext.request.contextPath}/doregister">
				...
				<div class="field">
					<label>性别:</label>
					<input style="width: 30px" type="radio" id="man" name="gender" value="1" checked="checked">男
					<input style="width: 30px"  type="radio" id="woman" name="gender" value="0">女
				</div>
				<div class="field">
					<input  class='button color medium' type="submit"  value="注册">
				</div>
			</form>
		</div>
</div>
